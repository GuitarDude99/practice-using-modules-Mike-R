...
/* 
Short Written comments in code, addressing....

Q: Describe The purpose of package.json in managing dependencies.

A: package.json helps store and move data. 
 It is used by npm to manage dependancies withing a project


Q: Why node_modules should not be included in version control?

A: Including it would allow other developers to change dependancies.
  This could lead to many porblems!

Q: How npm install reinstalls dependencies and its importance in
collaborative projects.

A: Running npm install will install everything that is included in package.json
It makes your code more modular,alloowing for easier collaboration.
*/
